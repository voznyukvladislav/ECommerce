...
{
    /// <inheritdoc />
    public partial class AddednewtablesOrder_ProductShoppingCart_Product : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShoppingCart_Product", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ShoppingCart_Product_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ShoppingCart_Product_ShoppingCarts_ShoppingCartId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShoppingCart_Product_ShoppingCartId",
                table: "ShoppingCart_Product",
