...
namespace ECommerceApp_API.Core.DTOs.ProductDTOs
{
    public class ProductSimpleDTO
    {
        ...
        public ProductSimpleDTO(Product product)
        {
            ...
            this.Rating = product.Reviews is null || product.Reviews.Count == 0  ? 0.00 : product.Reviews.Average(r => r.Rating);
            this.ReviewsCount = product.Reviews is null || product.Reviews.Count == 0 ? 0 : product.Reviews.Count;
            ...
            this.Photo = product.Photos is null || product.Photos?[0].Source is null ? "" : product.Photos?[0].Source;
